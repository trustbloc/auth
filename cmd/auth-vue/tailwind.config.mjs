...
export default {
  ...
  theme: {
    ...
    gradients: (theme) => ({
      boatBlue: `linear-gradient(-225deg, ${theme(
        'colors.primary.boatBlue.dark'
      )} 0%, ${theme('colors.primary.boatBlue.light')} 100%)`,
      cinnabar: `linear-gradient(${theme(
        'gradientColorStops.cinnabar.DEFAULT'
      )} 0%, ${theme('gradientColorStops.darkTan')} 100%)`,
      cinnabarLight: `linear-gradient(${theme(
        'gradientColorStops.cinnabar.light'
      )} 0%, ${theme('gradientColorStops.darkTan')} 100%)`,
      cobalt: `linear-gradient(-225deg, ${theme(
        'colors.primary.cobalt.dark'
      )} 0%, ${theme('colors.primary.cobalt.light')} 100%)`,
      dark: `linear-gradient(-135deg, ${theme(
        'gradientColorStops.haiti'
      )} 0%, ${theme('gradientColorStops.ebony')} 100%)`,
      full: `linear-gradient(153deg, ${theme(
        'gradientColorStops.apricot'
      )} 0%, ${theme('gradientColorStops.hibiscus.dark')} 26%, ${theme(
        'gradientColorStops.copperfield'
      )} 47%, ${theme('gradientColorStops.vividViolet.DEFAULT')} 66%, ${theme(
        'gradientColorStops.blueViolet'
      )} 83%, ${theme('gradientColorStops.curiousBlue')} 100%)`,
      green: `linear-gradient(-225deg, ${theme(
        'colors.primary.green.dark'
      )} 0%, ${theme('colors.primary.green.light')} 100%)`,
      haroldLight: `linear-gradient(-135deg, ${theme(
        'gradientColorStops.harold'
      )} 0%, ${theme('gradientColorStops.hummer')} 100%)`,
      iron: `linear-gradient(${theme('gradientColorStops.iron')} 0%, ${theme(
        'gradientColorStops.eastSide'
      )} 100%)`,
      lavender: `linear-gradient(${theme(
        'gradientColorStops.lavender'
      )} 0%, ${theme('gradientColorStops.jagger')} 100%)`,
      moonRaker: `linear-gradient(${theme(
        'gradientColorStops.neutrals.white'
      )} 0%, ${theme('gradientColorStops.moonRaker')} 100%)`,
      pink: `linear-gradient(-135deg, ${theme(
        'gradientColorStops.hibiscus.DEFAULT'
      )} 0%, ${theme('gradientColorStops.grape')} 100%)`,
      purple: `linear-gradient(${theme(
        'gradientColorStops.vividViolet.dark'
      )} 0%, ${theme('gradientColorStops.jagger')} 100%)`,
      red: `linear-gradient(-225deg, ${theme(
        'colors.primary.red.dark'
      )} 0%, ${theme('colors.primary.red.light')} 100%)`,
    }),
    spacing: {
      px: '1px',
      0: '0px',
    ...
    extend: {
      backgroundImage: (theme) => ({
        ...
        onboarding: "url('@/assets/bg-onboarding.svg')",
        'onboarding-sm': "url('@/assets/bg-onboarding-sm.svg')",
      }),
      boxShadow: (theme) => ({
        ...
        '.input-container': {
          ...
          '& input': {
            ...
            borderBottom: `2px solid ${theme(
              'colors.neutrals.mountainMist.light'
            )}`,
