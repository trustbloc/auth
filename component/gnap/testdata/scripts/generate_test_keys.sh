...
openssl req -new -key testdata/crypto/tls/ec-key.pem -subj "/C=CA/ST=ON/O=Example Inc.:trustbloc/OU=trustbloc/CN=*.example.com" -reqexts SAN -config testdata/crypto/openssl.cnf -out testdata/crypto/tls/ec-key.csr
...
openssl req -new -key testdata/crypto/ec-key1.pem -subj "/C=CA/ST=ON/O=Example Inc.:trustbloc/OU=trustbloc/CN=*.example.com" -reqexts SAN -config testdata/crypto/openssl.cnf -out testdata/crypto/ec-key1.csr
...
openssl req -new -key testdata/crypto/ec-key2.pem -subj "/C=CA/ST=ON/O=Example Inc.:trustbloc/OU=trustbloc/CN=*.example.com" -reqexts SAN -config testdata/crypto/openssl.cnf -out testdata/crypto/ec-key2.csr
